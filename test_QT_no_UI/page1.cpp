...
void page1::retranslateUi(){
    this->setWindowTitle(QCoreApplication::translate("Widget", "Widget", nullptr));
    this->pushButton->setText("haha");
    this->radioButton_3->setText(QCoreApplication::translate("Widget", "第一页", nullptr));
...
void page1::showid(int x){
    qDebug()<<x<<endl;
}

void page1::keyPressEvent(QKeyEvent *event){
